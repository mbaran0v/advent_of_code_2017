...
def resolve_part1(spreadsheet):
    result = 0
    for i in spreadsheet:
        j = sorted(i)
        # logging.debug(j)
        result = result + (int(j[len(j)-1]) - int(j[0]))

    return result


def resolve_part2(spreadsheet):
    result = 0
    for sub_list in spreadsheet:
...
def main():
    ...
    print('part 1: {}'.format(resolve_part1(spreadsheet)))
    print('part 2: {}'.format(resolve_part2(spreadsheet)))
